...
const VAD = function(options) {
    ...
    //   self.analyser.getFloatFrequencyData(self.floatFrequencyData); // заполняет floatFrequencyData данными
    //   self.update();
    //   self.monitor();
    // }
    ...
    this.monitor = function() {
      ...
      if(start && !this.vadState) {
        this.vadState = true;
        this.options.voice_start(logData);
      }
      if(end && this.vadState) {
        this.vadState = false;
        this.options.voice_stop(logData);
      }
    ...
    //   // console.log(this.floatFrequencyData)
    //   // this.analyser.getFloatFrequencyData(this.floatFrequencyData)
    //   this.analyser.getFloatFrequencyData(this.floatFrequencyData) // заполняет floatFrequencyData данными
    //   this.update() 
    //   this.monitor()
    // }
    // this.draw()
...
class VadAnalyzer extends AudioWorkletProcessor {
    constructor(props) {
        super()
        console.log({props})
        // this.vad = new VAD({})
...
registerProcessor('vad-analyzer', VadAnalyzer)